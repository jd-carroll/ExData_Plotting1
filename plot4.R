...
plot(february$timestamp, february$Voltage, type="l", ylab="Voltage", xlab="datetime")
...
legend("topright", c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), lty=c(1,1,1), bty = "n", col=c("black","blue","red"))

plot(february$timestamp, february$Global_reactive_power, type="l", ylab="Global Reactive Power", xlab="datetime")
